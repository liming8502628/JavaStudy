...
***
   ...
   * [三.Java异常常见面试题](#三java异常常见面试题)
      ...
      * [4. throw 和 throws 的区别是什么？](#4-throw-和-throws-的区别是什么)
      * [5. final、finally、finalize 有什么区别？](#5-finalfinallyfinalize-有什么区别)
      * [6. NoClassDefFoundError 和 ClassNotFoundException 区别？](#6-noclassdeffounderror-和-classnotfoundexception-区别)
      * [7. try-catch-finally 中哪个部分可以省略？](#7-try-catch-finally-中哪个部分可以省略)
      * [8. try-catch-finally 中，如果 catch 中 return 了，finally 还会执行吗？](#8-try-catch-finally-中如果-catch-中-return-了finally-还会执行吗)
   ...
   * [四.Java异常处理最佳实践](#四java异常处理最佳实践)
      ...
      * [5. 优先捕获最具体的异常](#5-优先捕获最具体的异常)
      * [6. 不要捕获 Throwable 类](#6-不要捕获-throwable-类)
      * [7. 不要忽略异常](#7-不要忽略异常)
      * [8. 不要记录并抛出异常](#8-不要记录并抛出异常)
      * [9. 包装异常时不要抛弃原始的异常](#9-包装异常时不要抛弃原始的异常)
      * [10. 不要使用异常控制程序的流程](#10-不要使用异常控制程序的流程)
      * [11. 使用标准异常](#11-使用标准异常)
