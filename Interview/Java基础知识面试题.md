...
=================
   ...
   * [一.Java概述](#一java概述)
      * [1.何为编程](#1何为编程)
      * [2.什么是Java](#2什么是java)
      * [3.jdk1.5之后的三大版本](#3jdk15之后的三大版本)
      * [4.JVM,JRE和JDK的关系](#4jvmjre和jdk的关系)
         * [(1).JVM](#1jvm)
         * [(2).JRE](#2jre)
         * [(3).JDK](#3jdk)
      * [5.什么是跨平台性?原理是什么](#5什么是跨平台性原理是什么)
      * [6.Java语言有哪些特点](#6java语言有哪些特点)
      * [7.什么是字节码?采用字节码的最大好处是什么](#7什么是字节码采用字节码的最大好处是什么)
      * [8.什么是Java程序的主类?应用程序和小程序的主类有何不同?](#8什么是java程序的主类应用程序和小程序的主类有何不同)
      * [9.Java应用程序与小程序之间有那些差别](#9java应用程序与小程序之间有那些差别)
      * [10.Java和C  的区别](#10java和c的区别)
      * [11.OracleJDK和OpenJDK的对比](#11oraclejdk和openjdk的对比)
   * [二.基础语法](#二基础语法)
      * [1.数据类型](#1数据类型)
         * [(1).Java有哪些数据类型](#1java有哪些数据类型)
         * [(2).switch是否能作用在byte上,是否能作用在long上,是否能作用在String上](#2switch是否能作用在byte上是否能作用在long上是否能作用在string上)
         * [(3).用最有效率的方法计算2乘以8](#3用最有效率的方法计算2乘以8)
         * [(4).Math.round(11.5) 等于多少?Math.round(-11.5)等于多少](#4mathround115-等于多少mathround-115等于多少)
         * [(5).float f=3.4;是否正确](#5float-f34是否正确)
         * [(6).short s1 = 1; s1 = s1   1;有错吗?short s1 = 1; s1  = 1;有错吗](#6short-s1--1-s1--s1--1有错吗short-s1--1-s1--1有错吗)
      * [2.编码](#2编码)
         * [(1).Java语言采用何种编码方案？有何特点？](#1java语言采用何种编码方案有何特点)
      * [3.注释](#3注释)
         * [(1).什么Java注释](#1什么java注释)
      * [4.访问修饰符](#4访问修饰符)
         * [(1).访问修饰符 public,private,protected,以及不写（默认）时的区别](#1访问修饰符-publicprivateprotected以及不写默认时的区别)
      * [5.运算符](#5运算符)
         * [(1).&amp;和&amp;&amp;的区别](#1和的区别)
      * [6.关键字](#6关键字)
         * [(1).Java 有没有 goto](#1java-有没有-goto)
         * [(2).final 有什么用？](#2final-有什么用)
         * [(3).final finally finalize区别](#3final-finally-finalize区别)
         * [(4).this关键字的用法](#4this关键字的用法)
         * [(5).super关键字的用法](#5super关键字的用法)
         * [(6).this与super的区别](#6this与super的区别)
         * [(7).static存在的主要意义](#7static存在的主要意义)
         * [(8).static的独特之处](#8static的独特之处)
         * [(9).static应用场景](#9static应用场景)
         * [(10).static注意事项](#10static注意事项)
      * [7.流程控制语句](#7流程控制语句)
         * [(1).break ,continue ,return 的区别及作用](#1break-continue-return-的区别及作用)
         * [(2).在 Java 中，如何跳出当前的多重嵌套循环](#2在-java-中如何跳出当前的多重嵌套循环)
   * [三.面向对象](#三面向对象)
      * [1.面向对象概述](#1面向对象概述)
         * [(1).面向对象和面向过程的区别](#1面向对象和面向过程的区别)
      * [2.面向对象三大特性](#2面向对象三大特性)
         * [(1).面向对象的特征有哪些方面](#1面向对象的特征有哪些方面)
         * [(2).什么是多态机制？Java语言是如何实现多态的？](#2什么是多态机制java语言是如何实现多态的)
         * [(3).面向对象五大基本原则是什么（可选）](#3面向对象五大基本原则是什么可选)
      * [3.类与接口](#3类与接口)
         * [(1).抽象类和接口的对比](#1抽象类和接口的对比)
         * [(2).普通类和抽象类有哪些区别？](#2普通类和抽象类有哪些区别)
         * [(3).抽象类能使用 final 修饰吗？](#3抽象类能使用-final-修饰吗)
         * [(4).创建一个对象用什么关键字？对象实例与对象引用有何不同？](#4创建一个对象用什么关键字对象实例与对象引用有何不同)
      * [4.变量与方法](#4变量与方法)
         * [(1).成员变量与局部变量的区别有哪些](#1成员变量与局部变量的区别有哪些)
         * [(2).在Java中定义一个不做事且没有参数的构造方法的作用](#2在java中定义一个不做事且没有参数的构造方法的作用)
         * [(3).在调用子类构造方法之前会先调用父类没有参数的构造方法，其目的是？](#3在调用子类构造方法之前会先调用父类没有参数的构造方法其目的是)
         * [(4).一个类的构造方法的作用是什么？若一个类没有声明构造方法，改程序能正确执行吗？为什么？](#4一个类的构造方法的作用是什么若一个类没有声明构造方法改程序能正确执行吗为什么)
         * [(5).构造方法有哪些特性？](#5构造方法有哪些特性)
         * [(6).静态变量和实例变量区别](#6静态变量和实例变量区别)
         * [(7).静态变量与普通变量区别](#7静态变量与普通变量区别)
         * [(8).静态方法和实例方法有何不同？](#8静态方法和实例方法有何不同)
         * [(9).在一个静态方法内调用一个非静态成员为什么是非法的？](#9在一个静态方法内调用一个非静态成员为什么是非法的)
         * [(10).什么是方法的返回值？返回值的作用是什么？](#10什么是方法的返回值返回值的作用是什么)
      * [5.内部类](#5内部类)
         * [(1).什么是内部类？](#1什么是内部类)
         * [(2).内部类的分类有哪些](#2内部类的分类有哪些)
         * [(3).内部类的优点](#3内部类的优点)
         * [(4).内部类有哪些应用场景](#4内部类有哪些应用场景)
         * [(5).局部内部类和匿名内部类访问局部变量的时候，为什么变量必须要加上final？](#5局部内部类和匿名内部类访问局部变量的时候为什么变量必须要加上final)
         * [(6).内部类相关，看程序说出运行结果](#6内部类相关看程序说出运行结果)
      * [6.重写与重载](#6重写与重载)
         * [(1).构造器（constructor）是否可被重写（override）](#1构造器constructor是否可被重写override)
         * [(2).重载（Overload）和重写（Override）的区别。重载的方法能否根据返回类型进行区分？](#2重载overload和重写override的区别重载的方法能否根据返回类型进行区分)
      * [7.对象相等判断](#7对象相等判断)
         * [(1).== 和 equals 的区别是什么](#1-和-equals-的区别是什么)
         * [(2).hashCode 与 equals (重要)](#2hashcode-与-equals-重要)
         * [(3).对象的相等与指向他们的引用相等，两者有什么不同？](#3对象的相等与指向他们的引用相等两者有什么不同)
      * [8.值传递](#8值传递)
         * [(1).当一个对象被当作参数传递到一个方法后，此方法可改变这个对象的属性，并可返回变化后的结果，那么这里到底是值传递还是引用传递](#1当一个对象被当作参数传递到一个方法后此方法可改变这个对象的属性并可返回变化后的结果那么这里到底是值传递还是引用传递)
         * [(2).为什么 Java 中只有值传递](#2为什么-java-中只有值传递)
         * [(3).值传递和引用传递有什么区别](#3值传递和引用传递有什么区别)
      * [9.Java包](#9java包)
         * [(1).JDK 中常用的包有哪些](#1jdk-中常用的包有哪些)
         * [(2).import java和javax有什么区别](#2import-java和javax有什么区别)
   * [四.IO流](#四io流)
      * [1.java 中 IO 流分为几种?](#1java-中-io-流分为几种)
      * [2.BIO,NIO,AIO有什么区别?](#2bionioaio有什么区别)
      * [3.Files的常用方法都有哪些？](#3files的常用方法都有哪些)
   * [五.反射](#五反射)
      * [1.什么是反射机制？](#1什么是反射机制)
      * [2.反射机制优缺点](#2反射机制优缺点)
      * [3.反射机制的应用场景有哪些](#3反射机制的应用场景有哪些)
      * [4.Java获取反射的三种方法](#4java获取反射的三种方法)
   * [六.常用API](#六常用api)
      * [1.String相关](#1string相关)
         * [(1).字符型常量和字符串常量的区别](#1字符型常量和字符串常量的区别)
         * [(2).什么是字符串常量池？](#2什么是字符串常量池)
         * [(3).String 是最基本的数据类型吗](#3string-是最基本的数据类型吗)
         * [(4).String有哪些特性](#4string有哪些特性)
         * [(5).String为什么是不可变的吗？](#5string为什么是不可变的吗)
         * [(6).String真的是不可变的吗？](#6string真的是不可变的吗)
         * [(7).是否可以继承 String 类](#7是否可以继承-string-类)
         * [(8).String str="i"与 String str=new String(“i”)一样吗？](#8string-stri与-string-strnew-stringi一样吗)
         * [(9).String s = new String(“xyz”);创建了几个字符串对象](#9string-s--new-stringxyz创建了几个字符串对象)
         * [(10).如何将字符串反转？](#10如何将字符串反转)
         * [(11).数组有没有 length()方法？String 有没有 length()方法](#11数组有没有-length方法string-有没有-length方法)
         * [(12).String 类的常用方法都有那些？](#12string-类的常用方法都有那些)
         * [(13).在使用 HashMap 的时候，用 String 做 key 有什么好处？](#13在使用-hashmap-的时候用-string-做-key-有什么好处)
         * [(14).String和StringBuffer、StringBuilder的区别是什么？String为什么是不可变的](#14string和stringbufferstringbuilder的区别是什么string为什么是不可变的)
      * [2.包装类相关](#2包装类相关)
         * [(1).自动装箱与拆箱](#1自动装箱与拆箱)
