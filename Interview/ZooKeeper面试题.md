# ZooKeeper面试题目录
   ...
   * [ZooKeeper 面试题](#zookeeper-面试题)
      ...
      * [3. Zookeeper 文件系统](#3-zookeeper-文件系统)
      ...
      * [17. 分布式集群中为什么会有 Master主节点？](#17-分布式集群中为什么会有-master主节点)
      ...
      * [21. 集群最少要几台机器，集群规则是怎样的？集群中有 3 台服务器，其中一个节点宕机，这个时候 Zookeeper 还可以使用吗？](#21-集群最少要几台机器集群规则是怎样的集群中有-3-台服务器其中一个节点宕机这个时候-zookeeper-还可以使用吗)
      ...
      * [29. Zookeeper 都有哪些功能？](#29-zookeeper-都有哪些功能)
      * [30. 说一下 Zookeeper 的通知机制？](#30-说一下-zookeeper-的通知机制)
      * [31. Zookeeper 和 Dubbo 的关系？](#31-zookeeper-和-dubbo-的关系)
